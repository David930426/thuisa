...
export default function Page() {
  return (
    <div className="w-full min-h-screen pb-10">
      ...
      <h1 className="max-w-5xl text-red-600 text-2xl md:text-4xl font-bold md:mx-auto  mx-10 mt-10 mb-5">
        Upcoming Events
      </h1>
      <div className="shadow-xl rounded-2xl max-w-6xl mx-auto p-10 flex md:gap-10 gap-5">
        <div>
          <Image
            src="/yingxin1.JPG"
            alt="yingxin1"
        ...
        <div>
          ...
          <Dialog>
            ...
            <DialogContent className="md:min-w-4xl max-h-[80vh] overflow-y-auto md:text-xl text-sm">
              ...
              <p>
                <span className="font-bold">Who Must Attend:</span> All new Indonesian freshmen at
                Tunghai University
              </p>
              <p>
