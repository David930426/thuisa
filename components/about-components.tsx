...
export function Priority() {
  return (
    <div className="max-w-5xl md:mx-auto px-10 mt-20 max-md:mb-10 max-md:text-center">
      <h1 className="text-3xl md:text-4xl font-bold mb-5 md:mb-8 text-red-600 dark:text-neutral-100">
        Our Priorities
      </h1>
      <p className="text-xl md:text-xl text-neutral-700 dark:text-neutral-400 max-md:hidden">
      ...
      <p className="text-xl md:text-xl text-neutral-700 dark:text-neutral-400 md:hidden">
...
export function VisionMission() {
  return (
    <div className="max-w-5xl mx-auto md:flex gap-6 max-md:mx-5">
      <div className="bg-neutral-100 dark:bg-red-600 shadow-md rounded-lg p-6 flex items-start gap-4 max-md:mb-5">
        <Target className="text-red-600 dark:text-neutral-100 w-9 h-9 flex-shrink-0" />
        <div>
          <h3 className="text-2xl font-bold text-red-600 dark:text-neutral-100">Our Mission</h3>
          <p className="text-neutral-700 dark:text-neutral-200 mt-2 text-xl">
            Support, connect, and empower Indonesian students in Tunghai
            University
          </p>
        </div>
      </div>
      <div className="bg-gray-100 dark:bg-amber-500 shadow-md rounded-lg p-6 flex items-start gap-4">
        <Globe2 className="text-yellow-500 dark:text-neutral-100 w-9 h-9 flex-shrink-0" />
        <div>
          <h3 className="text-2xl font-bold text-yellow-600 dark:text-neutral-100">Our Vision</h3>
          <p className="text-neutral-700 dark:text-neutral-200 mt-2 text-xl">
  ...
  return (
    <>
      ...
      <div className="max-w-5xl mx-10 md:mx-auto mt-20 mb-10 max-md:text-center">
        <h1 className="text-3xl md:text-3xl font-bold mb-4 md:mb-8 text-red-600 dark:text-neutral-100">
          THUISA at a Glance
        </h1>
        <p className="text-xl md:text-xl mb-4 md:mb-8 text-neutral-700 dark:text-neutral-400">
      ...
      <div className="md:flex justify-center items-center md:gap-8 md:divide-x md:divide-neutral-300">
        {information.map((info) => (
          <div
            className="px-6 text-center capitalize max-md:mt-5"
            key={info.title}
          >
            <p className="text-xl text-neutral-500 dark:text-neutral-300">{info.title}</p>
